...
class Peikko(Olento):
    ...
    def __init__(self, rohkeus = 3, katseen_voima = 4):
        """Konstruktori."""
        super().__init__(self._arvo_sanat(self.NIMITAVUT, 3, "-"), rohkeus, katseen_voima)
...
class Luolapeikko(Peikko):
    ...
    def __init__(self):
        """Konstruktori."""
        super().__init__(random.randint(8, 16), random.randint(4, 8))
...
class Sankari(Olento):
    ...
    HUUTO = ("OUNOU!", "OHHOH", "Saakeli!", "PER**!", "TOU")

    def __init__(self, nimi):
        """Konstruktori
        """
        super().__init__(nimi, random.randint(8,12), random.randint(4, 6))
    
    def arvo_hurraus(self):
        """Funktio valitsee randomisti huudon
        """
        return random.choice(self.HUUTO)
